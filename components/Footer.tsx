            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
                    <div className="col-span-2 lg:col-span-2">
                        <h2 className="text-2xl font-bold text-white">Aenzbi</h2>
                        <p className="mt-4 max-w-xs">
                            The complete developer platform for building, deploying, and scaling modern applications.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            <li><a href="/#/studio" className="hover:text-white">AenzbiStudio</a></li>
                            <li><a href="/#/pos" className="hover:text-white">eCommerce & POS</a></li>
                            <li><a href="/#/mobile-sdk" className="hover:text-white">Mobile SDK</a></li>
                             <li><a href="/#/app-builder" className="hover:text-white">App Builder</a></li>
                            <li><a href="/#/cloud-hosting" className="hover:text-white">Cloud Hosting</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            ...
                            <li><a href="/#/developer-training" className="hover:text-white">Training</a></li>
                ...
                <div className="mt-12 border-t border-gray-800 pt-8">
                    <p className="text-base text-center">&copy; 2024 Aenzbi. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );

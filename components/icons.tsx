...
export const TemplateIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75V3.75m3.75 16.5V3.75m-3.75 0h-3.75m3.75 0h3.75M9 20.25h3.75m-3.75 0H5.25m3.75 0h3.75m3.75-16.5h3.75m-3.75 0h-3.75m3.75 0V9m-3.75 11.25h3.75m-3.75 0H5.25m9-3.75h3.75M12 9V3.75m3.75 16.5h3.75m-3.75 0h-3.75" />
    </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.964 2.5-2.25 2.5h-10.5c-1.286 0-2.25-.964-2.25-2.25V6.75m15-3H4.875c-1.286 0-2.25.964-2.25 2.25v10.5c0 1.286.964 2.25 2.25 2.25h10.5" />
    </svg>
);
...
export const ShoppingCartIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.328 1.09-.832l-2.45-6.126A1.125 1.125 0 0016.5 4.5h-9a1.125 1.125 0 00-1.086.937L5.373 14.25M7.5 14.25v2.25m0-2.25h-1.5m3.75 0v2.25m0-2.25h-1.5m3.75 0v2.25m0-2.25h-1.5m3.75 0v2.25m0-2.25h-1.5" />
    </svg>
);
...
export const CloudArrowUpIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M17.25 12c0 2.485-2.015 4.5-4.5 4.5s-4.5-2.015-4.5-4.5c0-2.036 1.35-3.75 3.188-4.326a5.25 5.25 0 0110.124 0c1.838.576 3.188 2.29 3.188 4.326z" />
    </svg>
);
